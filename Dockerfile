# Minimal, robust Dockerfile for Next.js standalone
...
ENV TRACKER_PRIVATE_KEY_B64=$TRACKER_PRIVATE_KEY_B64
...
# Переустанавливаем runtime переменные окружения
ARG CONTACT_EMAIL_TO
ARG CONTACT_EMAIL_FROM
ARG SMTP_HOST
ARG SMTP_PORT
